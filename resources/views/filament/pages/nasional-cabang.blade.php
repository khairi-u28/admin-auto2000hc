  ...
  <div class="bg-white dark:bg-gray-800 p-4 rounded shadow border border-gray-100 dark:border-gray-700">
    ...
    <div class="mt-4 grid grid-cols-1 lg:grid-cols-5 gap-4">
      ...
      <div class="bg-white dark:bg-gray-800 p-4 rounded shadow border border-gray-100 dark:border-gray-700">
        ...
        <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ \DB::table('batch_participants')->join('employees','batch_participants.employee_id','=','employees.id')->where('employees.branch_id',$branch?->id)->where('batch_participants.status','lulus')->count() }}</div>
      </div>
      <div class="bg-white dark:bg-gray-800 p-4 rounded shadow border border-gray-100 dark:border-gray-700">
