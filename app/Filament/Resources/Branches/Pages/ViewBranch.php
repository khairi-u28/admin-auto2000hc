...
class ViewBranch extends ViewRecord
{
    ...
    public function getViewData(): array
    {
        ...
        try {
            ...
            $lpFulfillment = $karyawanPerJabatan->map(function($jab) 
                use ($branch, $batchIds) {
            ...
            return ['totalKaryawan'=>0,'activeBatch'=>0,'kelulusanPct'=>0,
                'karyawanPerJabatan'=>collect(),'lpFulfillment'=>collect(),
                'topGaps'=>collect(),'batchHistory'=>collect(),
                'inactiveCount'=>0,'upcomingEnd'=>collect()];
        }

        return compact('totalKaryawan','activeBatch','kelulusanPct',
            'karyawanPerJabatan','lpFulfillment','topGaps','batchHistory',
            'inactiveCount','upcomingEnd');
    }
